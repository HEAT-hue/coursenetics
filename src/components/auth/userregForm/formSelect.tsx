...
const FormSelect = React.forwardRef<HTMLSelectElement, { error: string | undefined, onChange: ChangeHandler, onBlur: ChangeHandler, name: string, defaultOption: string, selectOptions: selectOptionsType }>(({ onChange, onBlur, name, error, defaultOption, selectOptions }, ref) => {
    return (
        <div>
